export default (editor, options = {}) => {
  ...
  const opts = {
    ...{
      ...
      icons: {
        'menu.normalIcon.path': `${options.remoteIcons}/icon-d.svg`,
        'menu.activeIcon.path': `${options.remoteIcons}/icon-b.svg`,
        'menu.disabledIcon.path': `${options.remoteIcons}/icon-a.svg`,
        'menu.hoverIcon.path': `${options.remoteIcons}/icon-c.svg`,
        'submenu.normalIcon.path': `${options.remoteIcons}/icon-d.svg`,
        'submenu.activeIcon.path': `${options.remoteIcons}/icon-c.svg`,
      },
